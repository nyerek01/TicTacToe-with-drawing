...
public interface Interface {
    ...
    float perCent = 0.8f;
    String help = "<HTML>Help text. The game's rules:<br>1. Try to win.<br>2. Try harder.<br>3. Good luck.</HTML>", about = "<HTML>This is a sample text.<br>2015.01.12.<br>maybe the actual date? (getDate())<br>TicTacToe v1.2</HTML>", title = "Készítette: Somodi András && Dóra Dávid", checkUpdates = "Checking for Updates...", options = "<html>Under development<br>Cooming Soon</html>", win = "<html>You are the winer.<br>Are you want start a new game?<html>", lose = "<html>You are the loser.<br>Are you want start a new game?<html>", tie = "The game was ended. Tie";
